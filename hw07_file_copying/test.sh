...
./go-cp -from testdata/input.txt -to out.txt -offset 6000
cmp out.txt testdata/out_offset6000.txt

./go-cp -from testdata/input.txt -to out.txt -offset 6000 -limit 100
cmp out.txt testdata/out_offset6000_limit100.txt
